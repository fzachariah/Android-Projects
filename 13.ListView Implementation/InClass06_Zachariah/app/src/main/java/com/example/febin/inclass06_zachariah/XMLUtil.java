...
public class XMLUtil {
    ...
    static public class PullParser {
        ...
        static public ArrayList<Game> parseGame(InputStream inputStream)
        {
            ...
            try {
                ...
                int count=0;
                while(event!=XmlPullParser.END_DOCUMENT&& count<10)
                {
    ...
    static public class PullParserLink {

        static public String parseGameLink(InputStream inputStream)
        {
                ...
                while(event!=XmlPullParser.END_DOCUMENT)
                {
                    switch (event) {
                        case XmlPullParser.START_TAG:
                            ...
                            else if(xmlPullParser.getName().equals("clearlogo")&checkImage)
                            {
                                String imageUrl=xmlPullParser.nextText().toString().trim();;

                                url=" http://thegamesdb.net/banners/"+imageUrl;
                                Log.d("22222222222T123est::",url);
                                checkImage=false;
